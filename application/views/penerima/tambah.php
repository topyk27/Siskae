...
<head>
  ...
  <?php 
	...
	?>
  <title><?php echo $app; ?> | Penerima | Tambah</title>
              ...
              <form role="form" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?php echo form_error('no_hp') ? 'is-invalid' : ''; ?>" name="no_hp" value="<?php echo set_value('no_hp'); ?>" placeholder="Nomor WA" required>
                        <div class="invalid-feedback">

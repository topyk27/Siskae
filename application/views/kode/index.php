  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-2">
            <a href="kode/tambah" class="btn btn-block bg-gradient-primary">
        ...
        <div class="row">
          <div class="col-md-12">            
              <div class="card card-primary">
                <div class="card-body">
                    <table id="dt_kode" class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          <th></th>
                          <th>NO</th>                      
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      $("#sidebar_kode").addClass("active");
        dt_kode = $("#dt_kode").DataTable({
            ...
            columns : [
                ...
                {data: null, sortable: false, render: function(data,type,row,meta){
                    ...
                    a.setAttribute("href","<?php echo base_url('kode/ubah/'); ?>"+row['id']);
        ...
        $("#dt_kode tbody").on("click", "tr .deleteButton", function(e){
          e.preventDefault();
          ...
          let data = $("#dt_kode").DataTable().row(currentRow).data();          

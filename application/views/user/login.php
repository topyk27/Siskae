	...
	<div class="login-box">
		<div class="card card-outline card-primary">
			<div class="card-header text-center">
				<a href="<?php echo base_url(); ?>" class="h1"><b><?php echo $app; ?></b></a>
			</div>
			<div class="card-body">
				<p class="login-box-msg"><b>S</b>istem <b>I</b>nformasi <b>S</b>urat <b>K</b>eputusan Tug<b>a</b>s <b>E</b>lektronik</p>
